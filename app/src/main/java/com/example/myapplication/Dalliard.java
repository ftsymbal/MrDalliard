...
import com.mera.mrdalliard.DalliardAutoMessagingService;
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        protected void onStart() {
                ...
                bindService(new Intent(this, DalliardAutoMessagingService.class), mConnection, Context.BIND_AUTO_CREATE);
