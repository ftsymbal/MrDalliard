...
public class WearyElbows extends WearableActivity {

    private WearableRecyclerView recyclerView;
    private WearableRecyclerView.Adapter mAdapter;
    private WearableRecyclerView.LayoutManager layoutManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weary_elbows);
        ...
        recyclerView = findViewById(R.id.activated_recycler_view);
                ...
                FirebaseInstanceId.getInstance().getInstanceId()
                        .addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
                            ...
                            public void onComplete(@NonNull Task<InstanceIdResult> task) {
                                ...
                                Log.d(TAG, msg);
                                Toast.makeText(WearyElbows.this, msg, Toast.LENGTH_SHORT).show();
    ...
    protected void onResume() {
        ...
        if (activated)
        {
            Toast.makeText(WearyElbows.this, getString(R.string.greeting), Toast.LENGTH_SHORT).show();
